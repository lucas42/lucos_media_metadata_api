...
func TestCollectionWithInconsistentSlugs(test *testing.T) {
	...
	path := "/v2/collections/basic"
	makeRequest(test, "GET", path, "", 404, "Collection Not Found\n", false)
	makeRequest(test, "PUT", path, `{"slug":"awkward", "name": "A Basic Collection"}`, 200, `{"slug":"basic", "name": "A Basic Collection", "icon":"", "tracks":[], "totalPages":0}`, true)
	assertEqual(test, "Loganne event type", "collectionCreated", lastLoganneType)
	assertEqual(test, "Loganne humanReadable", "New Music Collection Created: A Basic Collection", lastLoganneMessage)
	assertEqual(test, "Loganne updatedCollection slug", "basic", lastLoganneUpdatedCollection.Slug)
	assertEqual(test, "Loganne existingCollection slug", "", lastLoganneExistingCollection.Slug)
	makeRequest(test, "GET", path, "", 200, `{"slug":"basic", "name": "A Basic Collection", "icon":"", "tracks":[], "totalPages":0}`, true)
	restartServer() // Clear Loganne counters etc
	makeRequest(test, "PUT", path, `{"slug":"different", "name": "A Basic Collection"}`, 200, `{"slug":"basic", "name": "A Basic Collection", "icon":"", "tracks":[], "totalPages":0}`, true)
...
func TestRenameCollection(test *testing.T) {
	...
	path := "/v2/collections/basic"
	makeRequest(test, "GET", path, "", 404, "Collection Not Found\n", false)
	makeRequest(test, "PUT", path, `{"name": "A Basic Collection"}`, 200, `{"slug":"basic","name": "A Basic Collection", "icon":"", "tracks":[], "totalPages":0}`, true)
	assertEqual(test, "Loganne event type", "collectionCreated", lastLoganneType)
	assertEqual(test, "Loganne humanReadable", "New Music Collection Created: A Basic Collection", lastLoganneMessage)
	assertEqual(test, "Loganne updatedCollection slug", "basic", lastLoganneUpdatedCollection.Slug)
	assertEqual(test, "Loganne existingCollection slug", "", lastLoganneExistingCollection.Slug)
	makeRequest(test, "GET", path, "", 200, `{"slug":"basic","name": "A Basic Collection", "icon":"", "tracks":[], "totalPages":0}`, true)
	makeRequest(test, "PUT", path, `{"name": "Advanced Collection"}`, 200, `{"slug":"basic","name": "Advanced Collection", "icon":"", "tracks":[], "totalPages":0}`, true)
	...
	makeRequest(test, "GET", path, "", 200, `{"slug":"basic","name": "Advanced Collection", "icon":"", "tracks":[], "totalPages":0}`, true)
	restartServer()
	makeRequest(test, "GET", path, "", 200, `{"slug":"basic","name": "Advanced Collection", "icon":"", "tracks":[], "totalPages":0}`, true)
}
...
func TestRenameClashCollection(test *testing.T) {
	clearData()
	makeRequest(test, "PUT", "/v2/collections/first", `{"name": "The Collection"}`, 200, `{"slug":"first","name": "The Collection", "icon":"", "tracks":[], "totalPages":0}`, true)
	makeRequest(test, "PUT", "/v2/collections/second", `{"name": "Another Collection"}`, 200, `{"slug":"second","name": "Another Collection", "icon":"", "tracks":[], "totalPages":0}`, true)
	restartServer()
	makeRequest(test, "PUT", "/v2/collections/second", `{"name": "The Collection"}`, 400, "Duplicate: collection first has same name\n", false)
	assertEqual(test, "Number of Loganne requests", 0, loganneRequestCount) // No requests to loganne made since server restart
	makeRequest(test, "GET", "/v2/collections/first", "", 200, `{"slug":"first","name": "The Collection", "icon":"", "tracks":[], "totalPages":0}`, true)
	makeRequest(test, "GET", "/v2/collections/second", "", 200, `{"slug":"second","name": "Another Collection", "icon":"", "tracks":[], "totalPages":0}`, true)
}

func TestChangeCollectionIcon(test *testing.T) {
	clearData()
	path := "/v2/collections/basic"
	makeRequest(test, "GET", path, "", 404, "Collection Not Found\n", false)
	makeRequest(test, "PUT", path, `{"name": "The Collection"}`, 200, `{"slug":"basic","name": "The Collection", "icon":"", "tracks":[], "totalPages":0}`, true)
	assertEqual(test, "Loganne event type", "collectionCreated", lastLoganneType)
	assertEqual(test, "Loganne humanReadable", "New Music Collection Created: The Collection", lastLoganneMessage)
	assertEqual(test, "Loganne updatedCollection slug", "basic", lastLoganneUpdatedCollection.Slug)
	assertEqual(test, "Loganne existingCollection slug", "", lastLoganneExistingCollection.Slug)
	makeRequest(test, "GET", path, "", 200, `{"slug":"basic","name": "The Collection", "icon":"", "tracks":[], "totalPages":0}`, true)
	makeRequest(test, "PUT", path, `{"icon": "💫"}`, 200, `{"slug":"basic","name": "The Collection", "icon":"💫", "tracks":[], "totalPages":0}`, true)
	assertEqual(test, "Loganne event type", "collectionUpdated", lastLoganneType)
	assertEqual(test, "Loganne humanReadable", "Music Collection The Collection Updated", lastLoganneMessage)
	assertEqual(test, "Loganne updatedCollection name", "The Collection", lastLoganneUpdatedCollection.Name)
	assertEqual(test, "Loganne existingCollection name", "The Collection", lastLoganneExistingCollection.Name)
	makeRequest(test, "GET", path, "", 200, `{"slug":"basic","name": "The Collection", "icon":"💫", "tracks":[], "totalPages":0}`, true)
	restartServer()
	makeRequest(test, "GET", path, "", 200, `{"slug":"basic","name": "The Collection", "icon":"💫", "tracks":[], "totalPages":0}`, true)
}
func TestAddTracksToCollectionOnDedicatedEndpoint(test *testing.T) {
	...
	makeRequest(test, "GET", "/v2/tracks/2", "", 200, `{"fingerprint":"def2","duration":14,"url":"http://example.org/track2","trackid":2,"tags":{"artist":"Dropkick Murphys", "title":"The Spicy McHaggis Jig"},"collections":[{"slug":"first","name": "The Collection", "icon":""}],"weighting": 0}`, true)
	makeRequest(test, "GET", "/v2/tracks/3", "", 200, `{"fingerprint":"ghi3","duration":21,"url":"http://example.org/track3","trackid":3,"tags":{"artist":"Pachabel", "title":"Canon in D"},"collections":[{"slug":"first","name": "The Collection", "icon":""}],"weighting": 0}`, true)
	...
	makeRequest(test, "GET", "/v2/collections/first", "", 200, `{"slug":"first","name": "The Collection", "icon":"", "tracks":[{"fingerprint":"def2","duration":14,"url":"http://example.org/track2","trackid":2,"tags":{"artist":"Dropkick Murphys", "title":"The Spicy McHaggis Jig"},"weighting": 0}],"totalPages":1}`, true)
	restartServer()
	makeRequest(test, "GET", "/v2/collections/first/1", "", 404, "Track Not In Collection\n", false)
	makeRequest(test, "GET", "/v2/collections/first/2", "", 200, "Track In Collection\n", false)
	makeRequest(test, "GET", "/v2/collections/first/3", "", 404, "Track Not In Collection\n", false)
	...
	makeRequest(test, "GET", "/v2/collections/first/3", "", 404, "Track Not In Collection\n", false)
	makeRequest(test, "GET", "/v2/collections/first", "", 200, `{"slug":"first","name": "The Collection", "icon":"", "tracks":[{"fingerprint":"def2","duration":14,"url":"http://example.org/track2","trackid":2,"tags":{"artist":"Dropkick Murphys", "title":"The Spicy McHaggis Jig"},"weighting": 0}],"totalPages":1}`, true)
	makeRequest(test, "GET", "/v2/collections/second", "", 200, `{"slug":"second","name": "Another Collection", "icon":"", "tracks":[], "totalPages":0}`, true)  // No requests touched this collection, so should stay empty
...
func TestAddTracksToCollectionOnTracksEndpoint(test *testing.T) {
	...
	restartServer()
	makeRequest(test, "PATCH", "/v2/tracks/1", `{"collections":[{"slug":"first"}]}`, 200, `{"fingerprint":"abc1","duration":7,"url":"http://example.org/track1","trackid":1,"tags":{"artist":"The Beatles", "title":"Yellow Submarine"},"collections":[{"slug":"first", "name": "The Collection", "icon":""}],"weighting": 0}`, true)
	makeRequest(test, "PATCH", "/v2/tracks/2", `{"collections":[{"slug":"first"},{"slug":"second"}]}`, 200, `{"fingerprint":"def2","duration":14,"url":"http://example.org/track2","trackid":2,"tags":{"artist":"Dropkick Murphys", "title":"The Spicy McHaggis Jig"},"collections":[{"slug":"first","name": "The Collection", "icon":""},{"slug":"second","name": "Another Collection", "icon":""}],"weighting": 0}`, true)
	makeRequest(test, "PATCH", "/v2/tracks/3", `{"collections":[{"slug":"first"},{"slug":"second"}]}`, 200, `{"fingerprint":"ghi3","duration":21,"url":"http://example.org/track3","trackid":3,"tags":{"artist":"Pachabel", "title":"Canon in D"},"collections":[{"slug":"first","name": "The Collection", "icon":""},{"slug":"second","name": "Another Collection", "icon":""}],"weighting": 0}`, true)
	...
	restartServer()
	makeRequest(test, "GET", "/v2/tracks/1", "", 200, `{"fingerprint":"abc1","duration":7,"url":"http://example.org/track1","trackid":1,"tags":{"artist":"The Beatles", "title":"Yellow Submarine"},"collections":[{"slug":"first", "name": "The Collection", "icon":""}],"weighting": 0}`, true)
	makeRequest(test, "GET", "/v2/tracks/2", "", 200, `{"fingerprint":"def2","duration":14,"url":"http://example.org/track2","trackid":2,"tags":{"artist":"Dropkick Murphys", "title":"The Spicy McHaggis Jig"},"collections":[{"slug":"first","name": "The Collection", "icon":""},{"slug":"second","name": "Another Collection", "icon":""}],"weighting": 0}`, true)
	makeRequest(test, "GET", "/v2/tracks/3", "", 200, `{"fingerprint":"ghi3","duration":21,"url":"http://example.org/track3","trackid":3,"tags":{"artist":"Pachabel", "title":"Canon in D"},"collections":[{"slug":"first","name": "The Collection", "icon":""},{"slug":"second","name": "Another Collection", "icon":""}],"weighting": 0}`, true)

	makeRequest(test, "PATCH", "/v2/tracks/2", `{"collections":[{"slug":"second"}]}`, 200, `{"fingerprint":"def2","duration":14,"url":"http://example.org/track2","trackid":2,"tags":{"artist":"Dropkick Murphys", "title":"The Spicy McHaggis Jig"},"collections":[{"slug":"second","name": "Another Collection", "icon":""}],"weighting": 0}`, true)
	makeRequest(test, "GET", "/v2/collections/first", "", 200, `{"slug":"first", "name": "The Collection", "icon":"", "tracks":[{"fingerprint":"abc1","duration":7,"url":"http://example.org/track1","trackid":1,"tags":{"artist":"The Beatles", "title":"Yellow Submarine"},"weighting": 0},{"fingerprint":"ghi3","duration":21,"url":"http://example.org/track3","trackid":3,"tags":{"artist":"Pachabel", "title":"Canon in D"},"weighting": 0}],"totalPages":1}`, true)
	makeRequest(test, "GET", "/v2/collections/second", "", 200, `{"slug":"second", "name": "Another Collection", "icon":"", "tracks":[{"fingerprint":"def2","duration":14,"url":"http://example.org/track2","trackid":2,"tags":{"artist":"Dropkick Murphys", "title":"The Spicy McHaggis Jig"},"weighting": 0},{"fingerprint":"ghi3","duration":21,"url":"http://example.org/track3","trackid":3,"tags":{"artist":"Pachabel", "title":"Canon in D"},"weighting": 0}],"totalPages":1}`, true)
...
func TestListCollections(test *testing.T) {
	...
	makeRequest(test, "PUT", "/v2/collections/first", `{"name": "The Collection"}`, 200, `{"slug":"first", "name": "The Collection", "icon":"", "tracks":[], "totalPages":0}`, true)
	makeRequest(test, "PUT", "/v2/collections/second", `{"name": "Another Collection"}`, 200, `{"slug":"second", "name": "Another Collection", "icon":"", "tracks":[], "totalPages":0}`, true)
	makeRequest(test, "PUT", "/v2/collections/third", `{"name": "Collecty McCollectFace"}`, 200, `{"slug":"third", "name": "Collecty McCollectFace", "icon":"", "tracks":[], "totalPages":0}`, true)
	makeRequest(test, "PUT", "/v2/tracks?fingerprint=abc1", `{"url":"http://example.org/track1", "duration": 7,"tags":{"artist":"The Beatles", "title":"Yellow Submarine"}}`, 200, `{"fingerprint":"abc1","duration":7,"url":"http://example.org/track1","trackid":1,"tags":{"artist":"The Beatles", "title":"Yellow Submarine"},"collections":[],"weighting": 0}`, true)
	makeRequest(test, "PUT", "/v2/tracks?fingerprint=def2", `{"url":"http://example.org/track2", "duration": 14,"tags":{"artist":"Dropkick Murphys", "title":"The Spicy McHaggis Jig"}}`, 200, `{"fingerprint":"def2","duration":14,"url":"http://example.org/track2","trackid":2,"tags":{"artist":"Dropkick Murphys", "title":"The Spicy McHaggis Jig"},"collections":[],"weighting": 0}`, true)
	...
	restartServer()
	makeRequest(test, "GET", "/v2/collections", "", 200, `[{"slug":"first","name": "The Collection", "icon":"", "totalTracks":2, "totalPages":1, "isPlayable": true},{"slug":"second","name": "Another Collection", "icon":"", "totalTracks":0, "totalPages":0, "isPlayable": false},{"slug":"third","name": "Collecty McCollectFace", "icon":"", "totalTracks":1, "totalPages":1, "isPlayable": false}]`, true)
	makeRequest(test, "GET", "/v2/collections/", "", 200, `[{"slug":"first","name": "The Collection", "icon":"", "totalTracks":2, "totalPages":1, "isPlayable": true},{"slug":"second","name": "Another Collection", "icon":"", "totalTracks":0, "totalPages":0, "isPlayable": false},{"slug":"third","name": "Collecty McCollectFace", "icon":"", "totalTracks":1, "totalPages":1, "isPlayable": false}]`, true)
...
func TestCollectionPagination(test *testing.T) {
	clearData()
	makeRequest(test, "PUT", "/v2/collections/bigone", `{"name": "Large Collection"}`, 200, `{"slug":"bigone", "name": "Large Collection", "icon":"", "tracks":[], "totalPages":0}`, true)
	...
	for i := 1; i <= 45; i++ {
		...
		outputJson := `{"fingerprint": "abcde` + id + `", "duration": 350, "url": "` + trackurl + `", "trackid": ` + id + `, "tags": {},"collections":[{"slug":"bigone", "name": "Large Collection", "icon":""}], "weighting": 0}`
...
func TestDeleteCollection(test *testing.T) {
	...
	makeRequest(test, "PUT", "/v2/tracks?fingerprint=abc1", `{"url":"http://example.org/track1", "duration": 7,"tags":{"artist":"The Beatles", "title":"Yellow Submarine"}}`, 200, `{"fingerprint":"abc1","duration":7,"url":"http://example.org/track1","trackid":1,"tags":{"artist":"The Beatles", "title":"Yellow Submarine"},"collections":[],"weighting": 0}`, true)
	makeRequest(test, "PUT", "/v2/collections/first/1", "", 200, "Track In Collection\n", false)
	makeRequest(test, "GET", "/v2/collections/first", "", 200, `{"slug":"first", "name": "The Collection", "icon":"", "tracks":[{"fingerprint":"abc1","duration":7,"url":"http://example.org/track1","trackid":1,"tags":{"artist":"The Beatles", "title":"Yellow Submarine"},"weighting": 0}],"totalPages":1}`, true)
	restartServer()
...
func TestCollectionRandomTracks(test *testing.T) {
	...
	makeRequest(test, "PUT", "/v2/collections/rand-coll", `{"name": "Random Collection"}`, 200, `{"slug":"rand-coll", "name": "Random Collection", "icon":"", "tracks":[], "totalPages":0}`, true)

	// Check the random function when the collection is empty
	makeRequest(test, "GET", path, "", 200, `{"slug":"rand-coll", "name": "Random Collection", "icon":"", "tracks":[], "totalPages":0}`, true)
	...
	for i := 1; i <= 40; i++ {
		...
		outputJson := `{"fingerprint": "abcde` + id + `", "duration": 350, "url": "` + trackurl + `", "trackid": ` + id + `, "tags": {},"collections":[{"slug":"rand-coll","name": "Random Collection", "icon":""}], "weighting": 0}`
		makeRequest(test, "PUT", trackpath, inputJson, 200, outputJson, true)
		makeRequest(test, "PUT", "/v2/tracks/"+id+"/weighting", "4.3", 200, "4.3", false)
	}
	request := basicRequest(test, "GET", path, "")
