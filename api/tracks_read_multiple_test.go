...
func TestMultiPredicateQuery(test *testing.T) {
	...
	setupRequest(test, "PUT", "/v3/tracks?fingerprint=abc1", `{"url":"http://example.org/track1", "duration": 7,"tags":{"album":[{"uri":"/albums/1"}],"artist":[{"name":"The Corrs"}],"title":[{"name":"What Can I Do"}]}}`, 200)
	// Album Now 42, Artist Beautiful South
	setupRequest(test, "PUT", "/v3/tracks?fingerprint=abc2", `{"url":"http://example.org/track2", "duration": 7,"tags":{"album":[{"uri":"/albums/1"}],"artist":[{"name":"The Beautiful South"}],"title":[{"name":"How Long"}]}}`, 200)
	// Album Now 42, Artist Divine Comedy
	setupRequest(test, "PUT", "/v3/tracks?fingerprint=abc3", `{"url":"http://example.org/track3", "duration": 7,"tags":{"album":[{"uri":"/albums/1"}],"artist":[{"name":"The Divine Comedy"}],"title":[{"name":"National Express"}]}}`, 200)
	// Album Now 41, Artist Beautiful South
	setupRequest(test, "PUT", "/v3/tracks?fingerprint=abc4", `{"url":"http://example.org/track4", "duration": 7,"tags":{"album":[{"uri":"/albums/2"}],"artist":[{"name":"The Beautiful South"}],"title":[{"name":"Perfect 10"}]}}`, 200)
