...
func TestLoganneEvent(test *testing.T) {
	...
	loganne.post("testEvent", "This event is from the test", track)
	...
	assertEqual(test, "Unexpect request body", `{"humanReadable":"This event is from the test","source":"metadata_api_test","track":{"fingerprint":"abc","duration":137,"url":"http://example.com/track-1.mp3","trackid":17,"tags":{"album":"Harvest Storm","artist":"Altan"},"weighting":9},"type":"testEvent"}`, latestRequestBody)
}
